...
description: "Junta el conector de GitHub (repos, PRs, issues, archivos) con Code Reviewer (revisa un diff o PR con hallazgos priorizados por severidad y evidencia), para que 'revisa este PR' sea una sola acción."
author: "TerminalSync"
...
- Quieres que tu IA revise un Pull Request o un cambio en tus repos de GitHub, sin pegar el diff a mano.
- Quieres una revisión con hallazgos priorizados por severidad, con evidencia —no un "se ve bien" genérico.
- Trabajas con Claude Code o Codex y quieres una segunda mirada antes de mergear.
...
**Un ejemplo real:** un colaborador abrió el PR #42 y no estás seguro de mergearlo. Le dices *"revisa el PR #42 de mi-org/mi-repo"*. GitHub trae el diff y los archivos que toca, Code Reviewer detecta un manejo de error faltante en una ruta nueva, una condición de carrera potencial y dos cosas menores de estilo, cada una con la línea exacta y por qué importa. Sabes qué pedir que arreglen antes de mergear —sin leer las 300 líneas a mano.

## Cómo usarlo

1. Instala el Plugin y conecta tu cuenta de GitHub.
2. Pide: *"revisa los cambios del PR #42 en mi-org/mi-repo"*.
3. Recibes los hallazgos priorizados con evidencia, listos para actuar antes de mergear.
