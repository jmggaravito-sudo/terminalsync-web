...
category: automation
status: available
simpleTitle: "Crea imágenes de marca desde tu agente"
...
Le pides *"Crea tres ideas de anuncio para Instagram para la promo del fin de semana, con headline en español bien legible"* y el agente puede llamar a Ideogram para generar opciones. Le pides *"Remixa esto en formato cuadrado y mantén el mismo estilo de marca"* y puede iterar sin sacarte del chat. El uso corre contra tu plan/créditos de Ideogram.

### Qué le puedes pedir

- *"Genera cuatro opciones de poster para el lanzamiento, con texto de titular legible."*
- *"Crea un mockup de producto para este bundle de skincare con look premium."*
- *"Remixa esta imagen en formato historia vertical manteniendo el mismo estilo."*
- *"Arma un set visual chico para una campaña: dirección de logo, hero image y posts."*

### Cómo conectas

Este conector **no te pide pegar una API key**. Usa tu cuenta de Ideogram:

1. Activas el conector en TerminalSync.
2. El puente `mcp-remote` abre el flujo OAuth de Ideogram en el navegador.
3. Inicias sesión y autorizas el acceso. Ideogram indica que el uso por MCP consume el mismo plan/créditos que la app web.
