...
description: "Builds and edits PowerPoint presentations from a prompt — slides, layouts, speaker notes — and reads content from existing decks. Ships natively with Claude Code."
tsInstallable: true
included: true
---
