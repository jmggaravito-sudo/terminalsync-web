...
items:
  - kind: connector
    slug: ahrefs
    reason: "Trae rankings de keywords, huecos de backlinks e ideas de contenido reales desde los datos SEO de la cuenta, así 'sobre qué deberíamos escribir' se responde con demanda de búsqueda real, no una corazonada."
  - kind: skill
    slug: seo-auditor
    reason: "Audita la página o el borrador contra bloqueadores SEO on-page y arreglos de alto impacto con evidencia y un veredicto puntuado, antes de que el post salga en vivo — no después de que el tráfico decepcione."
  - kind: skill
    slug: doc-coauthoring
    reason: "Convierte los hallazgos de keywords y auditoría en un borrador de blog estructurado, escrito sección por sección, en vez de un artículo genérico de una sola pasada."
  - kind: connector
    slug: wordpress
    reason: "Publica el post terminado y revisado directo en el sitio, así la investigación y la auditoría terminan en algo en vivo, no en un documento que nunca se publica."
---
## Para quién es
...
Este kit cubre el ciclo completo de investigación-a-publicación del marketing de contenidos:

- Encontrar ideas de keywords reales, huecos de ranking y oportunidades de backlinks con Ahrefs.
- Redactar un post de blog estructurado a partir de esos hallazgos con Doc Co-authoring.
- Auditar el borrador o la página donde va a vivir por bloqueadores SEO on-page con SEO Auditor, y obtener un veredicto puntuado antes de publicar.
- Publicar el post ya revisado directo en WordPress.

El resultado esperado es un post de blog que arrancó de demanda de búsqueda real, pasó un chequeo SEO con evidencia, y está en vivo en el sitio — sin hacer malabares entre una herramienta de keywords, un editor de texto, una checklist de auditoría y el panel de WordPress como cuatro pasos separados.
...
- **SEO Auditor** — convierte una URL o datos de página en una auditoría priorizada con evidencia y un veredicto de 0 a 100. Va acá porque un post debería pasar los bloqueadores SEO on-page antes de salir en vivo, no auditarse después de que rinda mal.
- **Doc Co-authoring** — arma el post sección por sección a partir de la investigación de keywords y los hallazgos de la auditoría, con pasadas de revisión en vez de un solo borrador sin revisar. Va acá porque un post de blog es un documento estructurado, no una generación de un solo tiro.

### CLI

No incluye ninguna herramienta CLI. El usuario objetivo suele ser no técnico, y el flujo investigar → auditar → redactar → publicar no requiere ejecución en terminal.
...
El kit es coherente porque sigue un solo flujo real de contenido, no cuatro herramientas de marketing sin relación:

- Ahrefs aporta **sobre qué escribir**, basado en datos reales de keywords y backlinks.
- Doc Co-authoring aporta **el post en sí**, construido con un proceso de redacción real en vez de una sola pasada genérica.
...
- Si tu sitio no corre en WordPress, los pasos de investigación y redacción igual funcionan, pero tendrías que publicar a mano o usar otro kit para el paso de publicación.
