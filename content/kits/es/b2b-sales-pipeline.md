...
Úsalo cuando el trabajo recurrente es "¿qué oportunidades necesitan atención, qué le mando a este prospecto, y a quién adentro hay que avisarle?" — no un tracker de una sola persona, sino un CRM que es el registro real.
...
1. Instala el kit y conecta HubSpot con un token de Private App, con scopes de solo lectura para arrancar.
2. Pregunta *"¿qué oportunidades en Propuesta o etapas posteriores no tuvieron actividad en dos semanas?"* y revisa lo que devuelve HubSpot.
3. Dale a Doc Co-authoring la oferta, los stakeholders, las objeciones y el timeline de la oportunidad, y pídele un primer borrador de propuesta o respuesta a RFP.
4. Registra la conversación resultante de vuelta en HubSpot: *"agrega una nota a este contacto y crea una tarea de seguimiento para el viernes."*
5. Cuando una oportunidad necesite atención interna, pídele a Internal Comms un update de status corto o una nota de handoff para tu manager o tu par de CS.
...
- Doc Co-authoring convierte ese estado en **lo que le mandas al prospecto**.
...
- No cierra oportunidades, no negocia ni manda nada en tu nombre — redacta y muestra, tú decides y mandas.
- HubSpot necesita su propio token de Private App, y el kit solo ve los scopes que ese token otorga — arranca en solo lectura y amplía a propósito.
...
- No es una herramienta de forecasting o reporting — para dashboards de pipeline y seguimiento de cuota, usa el reporting propio de HubSpot o una herramienta de BI.
