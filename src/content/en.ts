...
const en: Dict = {
  ...
  comparison: {
    ...
    title: "What no other AI tool does for you",
    subtitle:
      "Already using Claude, ChatGPT, or any AI? See what you gain with Terminal Sync. No tricks — if something is partial or we don't have it yet, the table says so.",
    columns: {
      feature: "Feature",
    ...
    groups: {
      persistence: "Industrial-grade persistence",
      mobility: "Mobility and multi-device",
    ...
    rows: {
      // Persistence
      resurrection: "Your agent keeps running even if you close the app",
      uninterruptedWork: "Works even when the internet drops",
      backgroundDaemon: "Runs in the background, not tied to the window",
      // Mobility
      multiDeviceProfile: "Your account and config on every device",
      anywhereAccess: "Access from your phone or any browser",
      pairProgramming: "Share your session with someone (read-only, revocable)",
      // Security
      aes256: "Military-grade AES-256 encryption — not even we can see your data",
      secretsVault: "Vault for your API keys and credentials",
      apiKeysKeychain: "Your keys protected by the OS Keychain",
      // AI native
      aiContinuity: "Your AI conversation survives anything",
      aiConfigSync: "Your AI set up the same on every device",
      oneClickInstall: "Install your favorite AI tools with one click",
      // Productivity
      multiCloudSync: "Your encrypted files in your cloud of choice (Drive, iCloud, Dropbox)",
      silenceNotifications: "Email / WhatsApp / Telegram alerts when the AI finishes or needs you",
      setupOnArrival: "Every project sets itself up the moment you open it",
      gitNativeSync: "Auto-backup of your progress (with history)",
    },
    upcomingLabel: "Coming soon",
