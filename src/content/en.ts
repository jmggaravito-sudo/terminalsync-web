...
const en: Dict = {
  ...
  hero: {
    ...
    trustLine: "No install · No context loss · Works on any computer · AES-256 · not even we can read your content",
    nextUp: {
      eyebrow: "Latest",
  ...
  comparison: {
    ...
    columns: {
      ...
      codex: "Codex alone",
      gemini: "Gemini CLI alone",
    },
    rows: {
      persistentMemory: "Persistent memory across sessions (your agent remembers)",
