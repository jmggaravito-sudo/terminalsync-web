...
const en: Dict = {
  ...
  memory: {
    eyebrow: "Persistent memory · included",
    badge: "Included",
    title: "Your business remembers. Every decision, every client, every process.",
    subtitle: "It's not AI memory: it's your company's knowledge, and it never gets lost.",
  ...
  multiAI: {
    ...
    title: "Your business, directed by you. Executed by your digital team.",
    subtitle:
  ...
  pricing: {
    ...
    plans: {
      ...
      pro: {
        ...
        price: "$19",
        priceNote: "/mo",
        tagline: "For anyone already delegating real work every week.",
        features: [
      ...
      max: {
        ...
        price: "$39",
        priceNote: "/mo",
        tagline: "For businesses that scale without hiring more people.",
        features: [
  ...
  chromeExtension: {
    ...
    status: "Available now on the Chrome Web Store",
