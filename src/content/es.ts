    ...
    plans: {
      ...
      dev: {
        ...
        features: [
          ...
          "Terminales de dev: cursor position, venv, shell history",
        ],
        cta: "Probar 7 días gratis",
      },
      team: {
        name: "Team",
        price: "$49",
        priceNote: "/usuario/mes",
        features: [
          "Todo lo de Dev, más:",
          "Panel de administración",
          "Terminales compartidas entre miembros",
          "Auditoría + control de seats",
          "Soporte prioritario",
        ],
