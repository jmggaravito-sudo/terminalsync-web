...
const es: Dict = {
  ...
  comparison: {
    ...
    subtitle:
      "¿Hoy usás Claude, ChatGPT o cualquier IA? Mirá lo que sumás con Terminal Sync. Sin trampas — si algo es parcial o todavía no lo tenemos, lo decimos en la tabla.",
    columns: {
    ...
    rows: {
      // Persistence
      resurrection: "Tu agente sigue corriendo aunque cierres la app",
      uninterruptedWork: "Funciona aunque se caiga internet",
      backgroundDaemon: "Trabaja en segundo plano sin depender de la ventana",
      // Mobility
      multiDeviceProfile: "Tu cuenta y configuración en todos tus equipos",
      anywhereAccess: "Acceso desde el celular o cualquier navegador",
      pairProgramming: "Compartir tu sesión con alguien (solo mirar, sin tipear)",
      // Security
      aes256: "Cifrado militar AES-256 — ni nosotros vemos tus datos",
      secretsVault: "Caja fuerte para tus claves API y credenciales",
      apiKeysKeychain: "Tus claves protegidas por el llavero del sistema",
      // AI native
      aiContinuity: "Tu conversación con la IA sobrevive a cualquier cosa",
      aiConfigSync: "Tu IA configurada igual en todos tus equipos",
      oneClickInstall: "Instala tus IA preferidas con un solo click",
      // Productivity
      multiCloudSync: "Tus archivos cifrados en tu nube favorita (Drive, iCloud, Dropbox)",
      silenceNotifications: "Aviso por Email / WhatsApp / Telegram cuando la IA termina o necesita algo",
      setupOnArrival: "Cada proyecto se configura solo al abrirlo",
      gitNativeSync: "Backup automático del progreso (con historial)",
    },
    upcomingLabel: "Próximamente",
