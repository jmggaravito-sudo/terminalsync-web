...
const es: Dict = {
  ...
  hero: {
    eyebrow: "Para quienes tienen problemas que resolver, no para programar.",
    titlePre: "Convierte tus ideas en ",
  ...
  multiAI: {
    ...
    problem: {
      ...
      items: [
        ...
        "Te repites todo el tiempo",
        "Cada cambio de IA = empezar de cero",
        "Tu trabajo se detiene constantemente",
      ],
    },
    solution: {
      ...
      items: [
        ...
        "Contexto compartido",
        "Tu equipo de IAs trabajando junto",
        "Memoria de proyecto que te sigue",
        "Sin repetir, sin saltar, sin fricción",
        "Tu trabajo no se detiene nunca",
      ],
    },
    useCases: {
      title: "Tu equipo de IAs. Una sola computadora. Todas sincronizadas.",
      cards: [
        {
          tool: "Claude",
          verb: "para pensar",
    ...
    tools: {
      ...
      gemini: {
        ...
        live: [
          ...
          "Free tier generoso (60 req/min, 1000/día) sin llave de acceso",
          "Conexión con tu cuenta de Google directo desde la app",
          "Apache 2.0 — open source, sin lock-in",
          "Sub-agents y settings roaman cifrados entre tus computadoras",
        ],
        upcoming: [],
      },
      codex: {
  ...
  chromeExtension: {
    ...
    status: "Disponible en Chrome Web Store",
