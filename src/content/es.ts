...
const es: Dict = {
    ...
    tools: {
      claudeCode: {
        ...
        live: [
          ...
          "Memoria por proyecto (CLAUDE.md, sessions JSONL)",
          "Skills custom",
          "Plugins manifest",
        ],
        upcoming: [
          "Auto-reinstall de plugins en Mac fresca",
        ],
      },
      cowork: {
        name: "Claude Cowork",
        ...
        live: [
          "Validado empíricamente (2026-04-25, transferencia manual)",
        ],
        upcoming: [
      ...
      codex: {
        ...
        live: [
          ...
          "Auto-resume con AI picker por terminal",
        ],
        upcoming: [
  ...
  comparison: {
    ...
    title: "Terminal Sync vs el resto",
    subtitle:
      "Comparado con las herramientas que probablemente estés usando hoy. Sin trampas, sin marketing — si algo es parcial o no lo tenemos todavía, lo decimos.",
    columns: {
      ...
      cursor: "Cursor",
      vercel: "Vercel CLI",
      itermTmux: "iTerm + tmux",
    },
    groups: {
      persistence: "Persistencia industrial",
      mobility: "Movilidad y multi-device",
      security: "Seguridad de grado bancario",
      ai: "AI nativo",
      productivity: "Productividad diaria",
    },
    rows: {
      // Persistence
      resurrection: "Resurrección de sesión (cerrás la app, el shell sigue corriendo)",
      uninterruptedWork: "Inmunidad a cortes de internet (el agente sigue local)",
      backgroundDaemon: "Multiplexer en daemon de fondo (independiente de la UI)",
      // Mobility
      multiDeviceProfile: "Sync de perfil multi-dispositivo (cuenta única)",
      anywhereAccess: "Anywhere Access — abrir desde el celular o cualquier navegador",
      pairProgramming: "Pair programming read-only (compartir sesión revocable)",
      // Security
      aes256: "Cifrado AES-256-GCM zero-knowledge",
      secretsVault: "Vault de secretos cifrado (.env por carpeta)",
      apiKeysKeychain: "API keys en Keychain del sistema (nunca en disco plano)",
      // AI native
      aiContinuity: "Continuidad de Claude/Codex (la conversación sobrevive)",
      aiConfigSync: "Sync de configs IA (skills, MCPs, ~/.claude)",
      oneClickInstall: "Instalación 1-click de Claude Code + Codex",
      // Productivity
      multiCloudSync: "Sync multi-cloud cifrado (Drive / iCloud / Dropbox)",
      silenceNotifications: "Notificaciones IA-aware (Email / WhatsApp / Telegram)",
      setupOnArrival: "Setup-on-arrival scripts por sesión",
      gitNativeSync: "Git-native sync por sesión (snapshots automáticos)",
    },
    upcomingLabel: "Próximamente",
