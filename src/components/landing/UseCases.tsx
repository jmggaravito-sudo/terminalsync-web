...
const T: Record<Locale, { eyebrow: string; title: string; subtitle: string; kProblem: string; kTransform: string; kBuild: string; cta: string; segments: Segment[] }> = {
  es: {
    ...
    segments: [
      ...
      { key: "meta", tab: "Meta/WhatsApp", problem: "Publicar, responder leads y revisar anuncios vive separado entre Facebook, Instagram, Ads Manager y WhatsApp.", transformation: "Un solo chat prepara posts, campañas, respuestas y reportes; vos aprobás antes de publicar o gastar.", outputs: ["“Publicá esta oferta en Facebook e Instagram”", "“Creá una campaña de $20 diarios y no la actives sin mi OK”", "“Respondé y calificá los leads que entran por WhatsApp”"] },
  ...
  en: {
    ...
    segments: [
      ...
      { key: "meta", tab: "Meta/WhatsApp", problem: "Publishing, lead replies and ad reviews are split across Facebook, Instagram, Ads Manager and WhatsApp.", transformation: "One chat prepares posts, campaigns, replies and reports; you approve before anything publishes or spends.", outputs: ["“Publish this offer on Facebook and Instagram”", "“Create a $20/day campaign and don't activate it without my OK”", "“Reply to and qualify leads coming from WhatsApp”"] },
